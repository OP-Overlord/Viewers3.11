...
function modeFactory({ modeConfiguration }) {
  ...
  return {
    ...
    onModeEnter: ({ servicesManager, extensionManager, commandsManager }: withAppTypes) => {
      ...
      // Prefetch en segundo plano: precarga el resto del display set activo y los
      // más cercanos tras el primer render. El servicio es singleton y viene
      // deshabilitado por defecto (nova-mobile lo desactiva por memoria).

...
export const Icons = {
  ...
  'tool-capture-nova': (props: IconProps) => ToolCaptureNOVA(props),
  'tool-cine': (props: IconProps) => ToolCine(props),
  'tool-cine-nova': (props: IconProps) => ToolCineNOVA(props),
  ...
  'tool-window-level-nova': (props: IconProps) => ToolWindowLevelNOVA(props),
